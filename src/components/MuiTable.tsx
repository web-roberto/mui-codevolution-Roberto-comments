...
export const MuiTable = () => {
  return (
    <>
    <h2> VIDEO 33 TABLE -Tablas básicas-con un scroll, no puede ordenar...</h2>
    <h5>*** para ordenar... react-table (tanstack) ****</h5>
    <h5>*** usa las mismas etiquetas que HTML **** más un TableContainer que lo engloba todo ****</h5>
